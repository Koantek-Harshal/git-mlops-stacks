...
git add README.md docs .gitignore rrx_mlops_demo/resources/README.md
...
If you want to use different catalog names, please update the target names declared in the[rrx-mlops-demo/databricks.yml](../rrx_mlops_demo/databricks.yml) file.
...
Follow the instructions in [rrx-mlops-demo/resources/README.md](../rrx_mlops_demo/resources/README.md) to deploy ML resources
and production jobs.
...
[ML resource config guide](../rrx_mlops_demo/resources/README.md)  to propose, test, and deploy
