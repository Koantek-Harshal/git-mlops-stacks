...
Opening a pull request will trigger a[workflow](../.github/workflows/rrx-mlops-demo-run-tests.yml) 
...
Links:
* [Staging model in UC](https://adb-xxxx.xx.azuredatabricks.net/explore/data/models/staging/rrx-mlops-demo/rrx-mlops-demo-model)
* [Prod model in UC](https://adb-xxxx.xx.azuredatabricks.net/explore/data/models/prod/rrx-mlops-demo/rrx-mlops-demo-model)
. 
