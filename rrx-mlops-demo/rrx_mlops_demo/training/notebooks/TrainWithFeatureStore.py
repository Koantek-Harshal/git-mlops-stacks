...
# ``rrx_mlops_demo/resources/model-workflow-resource.yml``
#
# Parameters:
...
dbutils.widgets.text(
    "experiment_name",
    f"/dev-rrx-mlops-demo-experiment",
    label="MLflow experiment name",
)
# Unity Catalog registered model name to use for the trained mode.
dbutils.widgets.text(
    "model_name", "dev.rrx_mlops_demo.rrx-mlops-demo-model", label="Full (Three-Level) Model Name"
)

# Pickup features table name
dbutils.widgets.text(
    "pickup_features_table",
    "dev.rrx_mlops_demo.trip_pickup_features",
...
dbutils.widgets.text(
    ...
    "dev.rrx_mlops_demo.trip_dropoff_features",
